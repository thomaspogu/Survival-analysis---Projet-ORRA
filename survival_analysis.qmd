...
task= TaskSurv$new(id = "veteran_lung", backend = veteran, time = "time", event = "status")
print(task)
set.seed(42)
learner = lrn("surv.coxph")
part = partition(task,ratio=0.8) # train/test split
...
# Uno's C-index
p$score(msr("surv.cindex", weight_meth = "G2"), #Must be element of set {'I','G','G2','SG','S','GH'}
